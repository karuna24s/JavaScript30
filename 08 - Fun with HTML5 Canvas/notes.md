...
The [HSL](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value)(see the "hsl()" section) is the Hue-saturation-lightness model using the `hsl()` function notation.
